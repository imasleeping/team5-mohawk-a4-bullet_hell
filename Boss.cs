        ...
        public void Update()
		{
            ...
            if (AttackPattern == 1)
			{
				...
				if (AttackTimer1 < 0)
				{
					...
					//{
                    Bullets.AddBullet(new Vector2(BulletSpawn.X, BulletSpawn.Y), (BulletSpawn - Position) * BulletSpeed, 2,10);
					//}
				}
			}
            if (AttackPattern == 2)
			...
			if (AttackPattern == 3)
			{
                ...
                if (AttackTimer3 < 0)
                {
                    ...
                    if (TargetTimer <= 0f)
                    {
                        ...
                        Bullets.AddBullet(new Vector2(BulletSpawn.X, BulletSpawn.Y), (BulletSpawn - RandomPosition) * BulletSpeed,2,10);
